...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    // Hämta info inkl. kundens e-postfält (både customer_email och contact_email, ifall olika varianter finns)
    ...
    // Skicka mail när vi faktiskt skickar prisförslaget
